...
export default function EditQuestionModal({ open, onClose, questionId, onUpdated }) {
        ...
        if (open && questionId) {
            ...
            QuestionService.getQuestionById(questionId)
                .then((data) => {
                    ...
                    let qType = data.question_type || "data_encoder";
                    if (qType === "junior") {
                        qType = "data_encoder";
                    } else if (qType === "experienced") {
                        qType = "supervisor";
                    }
    ...
    const handleSubmit = async () => {
        try {
            ...
            onUpdated({ id: questionId, ...payload });
            onClose();
        } catch (err) {
    ...
    return (
        <Dialog open={open} handler={onClose} size="lg">
            ...
            <DialogFooter>
                ...
                <Button color="green" onClick={handleSubmit}>Save Changes</Button>
            </DialogFooter>
        </Dialog>
    );
}